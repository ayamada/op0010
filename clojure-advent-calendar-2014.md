...
- 上記ゲームのソースコードは [src/cljs/op0010/core.cljs](src/cljs/op0010/core.cljs) にあります。
    - このファイル内の[main関数](src/cljs/op0010/core.cljs#L860)に、このゲームのシステム本体があり、そこを見てもらえれば **『`core.async`を使えば、このように比較的素直なコードでゲームのロジックが書き下せる』** という事が分かってもらえると思います。筆者がこの記事で訴えたい一番のポイントはここです。
...
この関数には [swal$](https://github.com/ayamada/op0010/blob/master/src/cljs/op0010/core.cljs#L186) という名前を付けた。
